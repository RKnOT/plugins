...
class rkn_MyButtonPlugin {
    ...
    public function __construct() {
        ...
        $this->current_url = dirname(dirname($plugin_dir));
         echo $this->current_url . '/js/my-custom-script.js';
    ...
    public function display_form() {
        ...
        $bild_url = $this->current_url . '/img/screenshot.png';
     ...
     public function enqueue_admin_scripts() {
        ...
        wp_enqueue_script(
            'b1-script',
             $this->current_url . '/js/my-custom-script.js',
             array('jquery'),
            '1.0',
             true);
